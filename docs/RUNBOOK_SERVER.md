...
cd /home/cmu/Desktop
git clone https://github.com/<redacted>/PercepFlex.git trac
cd trac
...
tar -cf ~/bdd100k_20260830.tar -C data bdd100k
# 若想更小可加 z 用 gzip：tar -czf ...（慢一些）
ls -lh ~/bdd100k_20260830.tar   # ~11G
```

**② 本机 → 服务器传输**（scp；若提示输密码是 cmu 登录密码，非 root）：
```bash
scp ~/bdd100k_20260830.tar cmu@HIVE:/home/cmu/Desktop/
# 或断点续传更快用 rsync：
rsync -avP ~/bdd100k_20260830.tar cmu@HIVE:/home/cmu/Desktop/
```
